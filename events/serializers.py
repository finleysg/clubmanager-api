...
class EventSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = Event
        fields = ("url", "id", "name", "courses", "description", "start_date", "rounds", "holes", "signup_start",
                  "signup_end", "start_time", "event_fee", "skins_fee", "minimum_signup_group_size",
...
class EventTemplateSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = EventTemplate
        fields = ("url", "id", "name", "description", "start_date", "rounds", "holes", "event_fee", "skins_fee",
